...
public class ForAbonentInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_for_abonent_information);
        ...
        try {
            ...
            Toast.makeText(ForAbonentInformationActivity.this,"Файл с IP:PORT не найден",Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            Toast.makeText(ForAbonentInformationActivity.this,"Ошибка чтения Файла с IP:PORT",Toast.LENGTH_SHORT).show();
        }
    ...
    public void sendData(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(ForAbonentInformationActivity.this);
        builder.setMessage("отключить абонент ?")
                .setTitle("Отключение абонета")
                .setCancelable(true)
                .setPositiveButton("отключить", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (isOnline()) {
                            new AsyncOkHttpOff().execute();
                        }else {
                            Toast.makeText(ForAbonentInformationActivity.this, "Нет подключения к интернету", Toast.LENGTH_SHORT).show();
                ...
                .setNegativeButton("отмена", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(ForAbonentInformationActivity.this, "Отмена", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    class AsyncOkHttpOff extends AsyncTask<Void,Void,Void> {
        String str = null;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ForAbonentInformationActivity.this);
            progressDialog.setTitle("Отключение абонента...");
        ...
        protected void onProgressUpdate(Void... values) {
            ...
            if(sst1!=null){
                Toast.makeText(ForAbonentInformationActivity.this,sst1,Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }else if(sst2!=null){
                Toast.makeText(ForAbonentInformationActivity.this,sst2,Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }else if(sst3!=null){
                Toast.makeText(ForAbonentInformationActivity.this,sst3,Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }else if(sst4!=null){
                Toast.makeText(ForAbonentInformationActivity.this,sst4,Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        ...
        protected Void doInBackground(Void... voids) {
             json = new JSONObject();
            if(namitype.equals("1")||namitype.equals("2")||namitype.equals("4")){
                   try {
                        json.put("cspot", cspot);
                        json.put("cspot2", cspot2);
                        json.put("address1", address1);
                        json.put("address2", address2);
                        json.put("namitype", namitype);
                        json.put("cstation", cstation);
                        json.put("nregion", nregion);
                        json.put("ccounter", ccounter);
                        json.put("ccounter", ccounter);
                        json.put("ccounter2", ccounter2);
                        json.put("ccounter20", ccounter20);
                    }catch(Exception ex){}
                    ...
                    try {
                        ...
                        if(jsonResult!=null){
                            ...
                            if(str!=null){
                                Log.e("результат-отключаемого",str);
                            }
                        }
                    } catch (IOException e) {
                    ...
                    if(str!=null&&str.equals("200")){
                        sst1 = "Абонент успешно отключен";
                        publishProgress();
                    }else if(str!=null&&str.equals("300")){
                        sst2 = "Абонент уже отключен";
                        publishProgress();
                    }else if(str!=null&&str.equals("100")){
                        sst3 = "Абонент не может быть отключен";
                        publishProgress();
                    }

                }else{
                        sst4 = "Абонент не может быть отключен";
                        publishProgress();
                }
